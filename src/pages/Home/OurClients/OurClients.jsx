...
const OurClients = () => {
    ...
    return (
        // <section className="py-16 bg-base-200 ">
            <div className="max-w-6xl mx-auto px-4 text-center border-b border-dashed mb-7">
                    ...
                    {logos.map((logo, index) => (
                        <div key={index} className="mx-24 flex items-center justify-center">
                            <img
                                ...
                                className="w-32 md:w-44 h-6 object-contain opacity-80 hover:opacity-100 transition mb-10"
                            />
                        </div>
                    ))}
                </Marquee>
